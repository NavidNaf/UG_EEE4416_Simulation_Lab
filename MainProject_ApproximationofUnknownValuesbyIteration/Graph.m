...
% Last Modified by GUIDE v2.5 09-Aug-2017 12:41:31
...
function surfaxes_CreateFcn(hObject, eventdata, handles)
% hObject    handle to surfaxes (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% Hint: place code in OpeningFcn to populate surfaxes
